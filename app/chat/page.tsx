                      ...
                      >
                        <div className="relative w-12 h-12 flex-shrink-0">
                          <Image
                            ...
                            className="object-cover rounded-full"
                          />
                          <span className="absolute bottom-0 right-0 w-3 h-3 bg-emerald-600 rounded-full border-2 border-white"></span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <h3 className="font-medium">{chat.user.name}</h3>
                          <p className="text-sm text-gray-500 truncate">
                        ...
                        <div className="flex flex-col items-end">
                          ...
                          <span className="w-5 h-5 bg-emerald-600 rounded-full text-white text-xs flex items-center justify-center">
                            2
                          </span>
                        </div>
                      </div>
